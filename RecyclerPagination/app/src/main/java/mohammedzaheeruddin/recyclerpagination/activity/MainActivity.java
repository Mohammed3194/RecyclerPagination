package mohammedzaheeruddin.recyclerpagination.activity;
...
import mohammedzaheeruddin.recyclerpagination.Utils;
import mohammedzaheeruddin.recyclerpagination.adapters.DisplayAdapter;
import mohammedzaheeruddin.recyclerpagination.db.Dao;
...
import mohammedzaheeruddin.recyclerpagination.entity.Item;
import mohammedzaheeruddin.recyclerpagination.retrofit.APIService;
import mohammedzaheeruddin.recyclerpagination.retrofit.ApiUtils;
import mohammedzaheeruddin.recyclerpagination.retrofit.ServiceConstants;
...
public class MainActivity extends AppCompatActivity{
    ...
    private void loadMoreData() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                displayItems.remove(displayItems.size()-1);
                getInitialDataFromApi(1);
            }
        }, 3000);
    }
    ...
    public class RecentRecordList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
            // TODO Auto-generated method stub
            searchList = (ArrayList<DisplayItem>) dao.getUserDetailsInDescendingOrder();
